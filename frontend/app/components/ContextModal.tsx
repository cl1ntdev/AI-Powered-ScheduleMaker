...
const ContextModal = ({ title: initialTitle, details: initialDetails, onClose, onSave }: ContextModalProps) => {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl p-8 space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-xs font-bold uppercase tracking-widest text-slate-400 ml-1">Details</label>
          <textarea 
